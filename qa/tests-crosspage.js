...
suite('Межстраничные тесты', function() {
    ...
    test('запрос расценок для групп со страницы туров по реке Худ '
        ...
        browser.visit(referrer, function() {
            browser.referer = referrer;
            browser.clickLink('.requestGroupRate', function() {
                console.log('refValue:', browser.field('referrer').value);  
                console.log('currentValue:', referrer);
    ...
    test('запрос страницы "Запрос цены для групп" напрямую '
